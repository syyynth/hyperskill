...
h_answers = ['HEADER: Brain Disconnects During Sleep',
...
t_answers = ['TEXT: Scientists may have gained an important insight into the age-old mystery of why consciousness fades as we nod off to sleep.',
             'Lines of communication between various parts of cerebral cortex - which buzz with activity during wakefulness - break down during slumber, researchers report today in Science.',
             'Early neuroscientists assumed that consciousness wanes during sleep because the cortex simply shuts off.',
             'But electroencephalography (EEG) and other modern methods have since ruled out that explanation, showing that the electrical chatter and metabolism of neurons in the cortex continues unabated during sleep.',
             'TEXT: Half a million years ago, several different members of our genus, Homo, had spread throughout Europe and Asia, where some would eventually evolve into Neandertals.',
             'But which ones has been the subject of intense debate.',
             ...
             'Researchers from the University of Exeter used survey data from 25,963 respondents in their investigations into the wellbeing effects of being by the coast.',
             'After taking other related factors into account, they found that living in large towns and cities near the coastline is linked with better mental health for those in the lowest earning households.',
             'TEXT: The number of years someone spends behind bars can hinge on whether they were clearly aware that they were committing a crime.',
             'But how is a judge or jury to know for sure?',
             'A new study suggests brain scans can distinguish between hardcore criminal intent and simple reckless behavior, but the approach is far from being ready for the courtroom.',
             'The study is unusual because it looks directly at the brains of people while they are engaged in illicit activity, says Liane Young, a Boston College psychologist who was not involved in the work.',
             'Earlier research, including work by her, has instead generally looked at the brains of people only observing immoral activity.',
             ...
             'Exports, which have proved volatile in recent quarters in response to threats of a trade war between the US and China, surged and imports declined to add 1.03 percentage points to GDP after being neutral in the fourth quarter.',
             'The improvement dispelled concerns the US economy was heading into recession as early as the summer, as some analysts had feared,after a slowdown last year.',
             'TEXT: Microsoft has become the third publicly listed US company, after Apple and Amazon, to boast a market value of more than $1tn after bumper quarterly results boosted its share price.',
             'The company beat sales and profits expectations in the three months to 31 March, thanks in part to its cloud computing business, which signed up major corporate clients over the period.',
             'Microsoft shares rose as much as 5% in early trading on Thursday, briefly pushing its market value above $1tn for the first time before dipping back below again when the shares price gain eased.',
             'It was the latest tech firm to join the prestigious club, after rival Apple and then Amazon topped the $1tn mark last year.',
             "TEXT: Siri, Apple's voice-controlled virtual assistant, is not just useful for hands-free texting, dictation and pizza place recommendations - it turns out she is also a skilled rapper.",
             "Last month, Judith Newman wrote in the New York Times how Siri had befriended her autistic son, and now it seems that Siri's talents go even further.",
             "London-based producers Skeewiff, aka Alex Rizzo and Elliot Ireland, have uploaded a remix of Young MC's Know How that features Siri.",
             "Siri's flow is reminiscent of Nicki Minaj's best work on Monster; she has cadence just as smooth as Angel Haze; and a potty mouth worthy of Azealia Banks.",
...
t_answers_s2 = [
    "TEXT: scientist may gained important insight age-old mystery consciousness fade nod sleep",
    "line communication various part cerebral cortex buzz activity wakefulness break slumber researcher report today science",
    "early neuroscientist assumed consciousness wane sleep cortex simply shuts",
    "electroencephalography eeg modern method since ruled explanation showing electrical chatter metabolism neuron cortex continues unabated sleep",
    "TEXT: half million year ago several different member genus homo spread throughout europe asia would eventually evolve neandertal",
    "one subject intense debate",
    "TEXT: people live close sea better mental health live away regardless household income new study suggests",
    "according scientist living near sea could support better mental health england 's poorest community",
    "researcher university exeter used survey data 25,963 respondent investigation wellbeing effect coast",
    "taking related factor account found living large town city near coastline linked better mental health lowest earning household",
    "TEXT: number year someone spends behind bar hinge whether clearly aware committing crime",
    "judge jury know sure",
    "new study suggests brain scan distinguish hardcore criminal intent simple reckless behavior approach far ready courtroom",
    "study unusual look directly brain people engaged illicit activity say liane young boston college psychologist involved work",
    "earlier research including work instead generally looked brain people observing immoral activity",
    "TEXT: computer better human dermatologist detecting skin cancer study pitted people machine quest better faster diagnostics researcher said tuesday",
    "team germany united state france taught artificial intelligence system distinguish dangerous skin lesion benign one showing 100,000 image",
    "machine deep learning convolutional neural network cnn tested 58 dermatologist 17 country shown photo malignant melanoma benign mole",
    "half dermatologist expert level five year experience 19 two five year experience 29 beginner le two year belt",
    "TEXT: u economic growth surged first three month year 3.2 threat trade war china forced business stockpile fastest rate since 2015",
    "figure department commerce showed jump hoarding raw material finished good increase government investment overcame weak consumer spending drop housebuilding low business investment send gdp growth well ahead 2.2 last quarter 2018",
    "export proved volatile recent quarter response threat trade war u china surged import declined add 1.03 percentage point gdp neutral fourth quarter",
    "improvement dispelled concern u economy heading recession early summer analyst feared slowdown last year",
    "TEXT: microsoft become third publicly listed u company apple amazon boast market value 1tn bumper quarterly result boosted share price",
    "company beat sale profit expectation three month 31 march thanks part cloud computing business signed major corporate client period",
    "microsoft share rose much 5 early trading thursday briefly pushing market value 1tn first time dipping back share price gain eased",
    "latest tech firm join prestigious club rival apple amazon topped 1tn mark last year",
    "TEXT: siri apple 's voice-controlled virtual assistant useful hands-free texting dictation pizza place recommendation turn also skilled rapper",
    "last month judith newman wrote new york time siri befriended autistic son seems siri 's talent go even",
    "london-based producer skeewiff aka alex rizzo elliot ireland uploaded remix young mc 's know feature siri",
    "siri 's flow reminiscent nicki minaj 's best work monster cadence smooth angel haze potty mouth worthy azealia bank",
    "TEXT: netflix viewer prefer diet comedy breakfast portion drama lunch break midnight snack documentary",
    "netflix 100 million subscriber worldwide said analysis viewing data found user service keen start day laugh watching comedy fuller house",
    "6am member 34 likely watch comedy time day data gathered user across 22 country show",
    "sneaking episode drama lunchtime emerged popular pastime show genre mad men bloodline orange new black accounting 47 viewing noon 2pm",
    "TEXT: lonely may make harder quit smoking new british study suggests",
    "using genetic survey data hundred thousand people researcher found loneliness make likely someone smoke",
    "type analysis called mendelian randomization",
]


sumb_answers = ['TEXT: Early neuroscientists assumed that consciousness wanes during sleep because the cortex simply shuts off.',
                'Communication between regions of the cortex might be one sign of this integration - and of consciousness, Tononi says.',
                'During non-rapid eye movement (non-REM) sleep, the same TMS stimulus only elicited neural activity at the site of stimulation.',
                'An important follow-up, he says, will be to repeat the experiments during late-night REM sleep, when people often report consciouslike experiences in the form of dreams.',
                ...
                'Published in the Health and Place journal, the findings suggest access to the coast could help to reduce these health inequalities in towns and cities close to the sea.',
                "The research used data from the Health Survey for England and compared people's health to their proximity to the coast.",
                'TEXT: Those differing brain patterns only showed up when people were first shown how many security checkpoints were guarded, and then offered the suitcases.',
                "Montague isn't sure why the results hinged on the order in which the scenario unfolded.",
                "We don't know what to do with this,'' Montague says.",
                'But another researcher who has used brain imaging to study criminal behavior questioned whether the differences found in the study really revealed a meaningful difference between the two mental states.',
                "And he cautions that it's a very big leap from there to visions of 'evil intent detectors' scanning people's brains.",
                'TEXT: On average,human dermatologists accurately detected 86.6% of skin cancers from the images, compared to 95% for the CNN.',
                "The dermatologists' performance improved when they were given more information of the patients and their skin lesions.",
                'There are about 232,000 new cases of melanoma, and 55,500 deaths, in the world each year, they added.',
                ...
                "TEXT: US economic growth surged in the first three months of the year to 3.2% as the threat of a trade war with China forced businesses to stockpile at the fastest rate since 2015.",
                'Figures from the Department of Commerce showed that a jump in hoarding raw materials and finished goods and an increase in government investment overcame weak consumer spending, a drop in housebuilding and low business investment to send GDP growth well ahead of the 2.2% in the last quarter of 2018.',
                "The Fed increased borrowing costs four times to a range of 2.25 to 2.5% in 2018, well above the level of base rates for most other major economies.",
                "The central bank is more likely to focus on a measure of domestic demand, which increased by only 1.3%, the slowest since the second quarter of 2013, after increasing by 2.6% in the last quarter.",
                'TEXT: Microsoft has become the third publicly listed US company, after Apple and Amazon, to boast a market value of more than $1tn after bumper quarterly results boosted its share price.',
                'Revenues in its cloud computing division jumped 14%, with US grocery firm Kroger and Walgreens Boots Alliance among the big client wins.',
                "Satya Nadella, the chief executive of Microsoft, said: 'Leading organisations of every size in every industry trust the Microsoft cloud.",
                'Shares in Microsoft were up 3.4% at $129 at close of trading in New York, giving it a market value of about $995bn.',
                "TEXT: London-based producers Skeewiff, aka Alex Rizzo and Elliot Ireland, have uploaded a remix of Young MC's Know How that features Siri.",
                "As well as name-checking Spotify and Google, Siri's enunciation of Young's rapid-fire lyrics are near-perfect, rapping: I'm tough like a bone / sly like Stallone / rocking and clocking on the microphone / smooth like a mirror / in hearts I strike terror / rhymes like runs / and rhymes with no errors.",
                "This is not the first time Siri has taken to the mic though.",
                "She has previously covered Eminem's Lose Yourself (not a great effort), and, to better effect, Notorious BIG's Hypnotize.",
                ...
                "'We've given consumers control and it's interesting to see the behaviours that emerge when viewers aren't tied to a schedule.'",
                "'Gone are the days of every household waking up to the same breakfast TV programming on their screens,' the company said.",
                "TEXT: 'We found evidence to suggest that loneliness leads to increased smoking, with people more likely to start smoking, to smoke more cigarettes and to be less likely to quit,' Wootton said in a university news release.",
                'The researchers also looked for a connection between loneliness and drinking but found none.',
                'Still, if loneliness causes people to smoke, it is important to alert smoking cessation services so they can add this factor as they help people to quit, the study authors said.']

tfidf_answers = ['TEXT: Early neuroscientists assumed that consciousness wanes during sleep because the cortex simply shuts off.',
                 'That left neuroscientists with a puzzle: If the brain is still active, why does consciousness wane?',
                 'Tononi has spent years developing a theory that equates consciousness with the integration of information.',
                 "'We would predict a pattern which is much more similar to wakefulness,' he says.",
...
tfidf_modified_answers = ['Scientists may have gained an important insight into the age-old mystery of why consciousness fades as we nod off to sleep.',
                          'Early neuroscientists assumed that consciousness wanes during sleep because the cortex simply shuts off.',
                          'That left neuroscientists with a puzzle: If the brain is still active, why does consciousness wane?',
                          "'We would predict a pattern which is much more similar to wakefulness,' he says.",
                          'But which ones has been the subject of intense debate.',
